...
class RepoService {
    ...
    let privateKey = "7999be95c88286b73c8307db79702f9638b54579"
    let apiKey = "51a895f62edd1b06b47c2c2122b0aab9"
    ...
    public func fetchFilms(completion: @escaping (ChareactersResult) -> Void ) {
        ...
        request.validate().responseDecodable(of: CharacterDataWrapper.self) { response in
